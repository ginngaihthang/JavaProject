...
public class CategoriesController implements Initializable{
	   @FXML
	    ...
	    @FXML
	    private TableView<Category> tbl_cateogry;
	    ...
	    void btn_delete_click(ActionEvent event) {
	    	var category = tbl_cateogry.getSelectionModel().getSelectedItem();
	    	if(category != null) {
	    ...
	    void btn_update_click(ActionEvent event) {
	    	String name = txt_name.getText();
	    	Category category = tbl_cateogry.getSelectionModel().getSelectedItem();
	    ...
	    public void initialize(URL arg0,ResourceBundle arg1) {
	    	...
	    	col_created_at.setCellValueFactory(new PropertyValueFactory<>("updated_at"));
	    	col_updated_at.setCellValueFactory(new PropertyValueFactory<>("updated_at"));
	    	loadCategories();
	    	tbl_cateogry.getSelectionModel().selectedItemProperty().addListener(
	    ...
	    private void loadCategories() {
	    	...
	    	tbl_cateogry.setItems(FXCollections.observableArrayList(categoryList));
	    }
}
